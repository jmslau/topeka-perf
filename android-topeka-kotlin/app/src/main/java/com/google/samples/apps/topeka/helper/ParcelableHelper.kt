...
object ParcelableHelper {
    ...
    /**
     * Writes a single boolean to a [android.os.Parcel].
     *
     * @param dest Destination of the value.
     * @param toWrite Value to write.
     * @see ParcelableHelper.readBoolean
     */
    fun writeBoolean(dest: Parcel, toWrite: Boolean) {
     ...
     * @see ParcelableHelper.writeBoolean
     */
     ...
     */
    fun writeEnumValue(dest: Parcel, e: Enum<*>) {
