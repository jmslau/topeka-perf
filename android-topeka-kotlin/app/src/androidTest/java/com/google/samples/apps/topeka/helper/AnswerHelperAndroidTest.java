...
public class AnswerHelperAndroidTest {
    ...
    public void partial_isAnswerCorrect_returnsTrue() throws Exception {
        assertThat(AnswerHelper.INSTANCE.isAnswerCorrect(mCorrectAnswer, OPTIONS), is(true));
    }

    @Test
    public void partial_isAnswerCorrect_returnsFalse() throws Exception {
        assertThat(AnswerHelper.INSTANCE.isAnswerCorrect(mCorrectAnswer, WRONG_OPTIONS), is(false));
    }
}