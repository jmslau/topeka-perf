...
public class CategorySelectionActivityTest {
    ...
    public ActivityTestRule<CategorySelectionActivity> mActivityRule =
            new ActivityTestRule<CategorySelectionActivity>(CategorySelectionActivity.class) {
                ...
                protected Intent getActivityIntent() {
                    ...
                    return CategorySelectionActivity.Companion.getStartIntent(mTargetContext, player);
                }
            };

    @Before
    public void loadCategories() {
        mCategories = TopekaDatabaseHelper.Companion.getCategories(mTargetContext, false);
    }
    ...
    public void signOut() {
        ...
        assertFalse(PreferencesHelper.INSTANCE.isSignedIn(mTargetContext));
    }
}
