    ...
    public final ActivityTestRule<QuizActivity> mActivityRule =
            new ActivityTestRule<QuizActivity>(QuizActivity.class) {
                ...
                protected void beforeActivityLaunched() {
                    ...
                    PreferencesHelper.INSTANCE.signOut(targetContext);
                    TopekaDatabaseHelper.Companion.reset(targetContext);
                    PreferencesHelper.INSTANCE.writeToPreferences(targetContext,
                ...
                protected Intent getActivityIntent() {
                    Context targetContext = InstrumentationRegistry.getTargetContext();
                    mCategories = TopekaDatabaseHelper.Companion.getCategories(targetContext, false);
                    return QuizActivity.Companion.getStartIntent(targetContext,
                            getCurrentCategory());
                }
            };
